...
import { TechCrestHero } from "./techcrest-hero";
...
export async function TechCrestLayout() {
  ...
  return (
    ...
    >
      {/* 1. TechCrest Hero Section */}
      <TechCrestHero articles={featured} />
        ...
        <div className="container">
          <div className="home-grid">
            ...
            <aside className="home-sidebar">
              ...
              {/* Gaming Highlights Widget */}
              <div className="sidebar-widget">
                <div className="sidebar-widget__header sidebar-widget__header--with-link">
                  <div className="sidebar-widget__header-left">
                    <Gamepad2 className="w-5 h-5 text-red-500" />
                    <h3 className="sidebar-widget__title">Gaming Highlights</h3>
                  </div>
                  <Link href="/gaming" className="sidebar-widget__link">
                    VIEW ALL <ArrowRight className="w-3 h-3" />
                  </Link>
                </div>
                <div className="review-list">
                  {editorsPicks.slice(0, 3).map((review: any) => (
                    <Link
                      key={review.id}
