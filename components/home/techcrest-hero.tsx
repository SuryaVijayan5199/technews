  ...
  return (
    ...
    >
      <div className="container">
        <div className="tc-hero-empty">
          <Flame className="tc-hero-empty__icon" />
          <h2 className="tc-hero-empty__title">
            No Articles Published Yet
          </h2>
          <p className="tc-hero-empty__desc">
            Use the{" "}
            <Link href="/dashboard/articles/new" className="tc-text-link">
              dashboard
            </Link>{" "}
...
export function TechCrestHero({ articles }: { articles: Article[] }) {
        ...
        <div className="hero-layout">
            ...
            <article className="hero-main">
              <div className="hero-main__image-wrap">
                {main.heroImage ? (
                  ...
                  <div className="hero-main__image tc-img-placeholder" />
                )}
                    ...
                    <div className="hero-main__author">
                      <div className="hero-main__author-avatar">
                        {main.author.avatar ? (
                          ...
                          <div className="hero-main__author-image tc-avatar-sm">
                    ...
                    {main.readingTimeMinutes && (
                      <>
                        ...
                        <span className="hero-main__read-time">
                          <Clock className="tc-icon-brand-sm" />{" "}
          ...
          {grid.length > 0 && (
            <div className="hero-grid-wrapper">
              {grid.map((story) => (
                <article key={story.id} className="hero-grid-item">
                  <div className="hero-grid-item__image-wrap">
                    {story.heroImage ? (
                      ...
                      <div className="hero-grid-item__image tc-img-placeholder" />
                    )}
                    {story.category && (
