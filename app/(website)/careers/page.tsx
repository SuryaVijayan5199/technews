...
export default function CareersPage() {
  return (
    <div className="container py-16 max-w-2xl mx-auto">
      ...
      <p className="text-muted-foreground">In the meantime, send your CV and portfolio to <a href="mailto:editor@techcrest.news" className="text-[#2D7FF9] underline">editor@techcrest.news</a></p>
    </div>
  );
}
