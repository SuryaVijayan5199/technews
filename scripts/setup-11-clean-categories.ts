...
const STANDARD_CATEGORIES = [
  { name: "News",        slug: "news",        description: "Latest technology news from around the world", icon: "/icons/techcrest-icon.svg", color: "#2D7FF9", sortOrder: 1 },
  { name: "Phone",       slug: "phone",       description: "Smartphones, reviews, and mobile news",         icon: "/icons/techcrest-icon.svg", color: "#0ea5e9", sortOrder: 2 },
  { name: "Audio",       slug: "audio",       description: "Headphones, speakers, and audio gear",          icon: "/icons/techcrest-icon.svg", color: "#8b5cf6", sortOrder: 3 },
  { name: "Robotic",     slug: "robotics",    description: "Robotics, automation, and AI hardware",        icon: "/icons/techcrest-icon.svg", color: "#6366f1", sortOrder: 4 },
  { name: "Fitness",     slug: "fitness",     description: "Wearables, health tech, and fitness gadgets",   icon: "/icons/techcrest-icon.svg", color: "#10b981", sortOrder: 5 },
  { name: "Security",    slug: "security",    description: "Cybersecurity, privacy, and data protection",    icon: "/icons/techcrest-icon.svg", color: "#f59e0b", sortOrder: 6 },
  { name: "Gaming",      slug: "gaming",      description: "Video games, consoles, PC gaming, hardware, and esports", icon: "/icons/techcrest-icon.svg", color: "#ef4444", sortOrder: 7 },
  { name: "AI",          slug: "ai",          description: "Artificial intelligence, LLMs, and machine learning", icon: "/icons/techcrest-icon.svg", color: "#a855f7", sortOrder: 8 },
  { name: "Home",        slug: "smart-home",  description: "Smart home devices, hubs, and automation",    icon: "/icons/techcrest-icon.svg", color: "#14b8a6", sortOrder: 9 },
  { name: "EVs",         slug: "evs",         description: "Electric vehicles, charging, and future mobility", icon: "/icons/techcrest-icon.svg", color: "#22c55e", sortOrder: 10 },
  { name: "Crypto",      slug: "crypto",      description: "Cryptocurrency, blockchain, and Web3",         icon: "/icons/techcrest-icon.svg", color: "#f97316", sortOrder: 11 },
];
